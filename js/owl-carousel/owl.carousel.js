...
;(function($, window, document, undefined) {
    ...
    Autoplay.prototype.play = function(timeout, speed) {
        ...
        this.core.prev(this.core.settings.autoplaySpeed);
    };
