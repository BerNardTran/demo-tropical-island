...
$(function ($) {
	...
	$('.header-menu-bar .button').on('click', function(){
		$('.header-menu-bar').toggleClass("open");
	});

	$('.header-menu-bar #remove-menubar').on('click', function(){
...
jQuery(document).ready(function ($) {
	...
	//owlCarousel3
	$('.category-slider-inner3').owlCarousel2({
		center: true,
		items:3,
		autoplay:true,
